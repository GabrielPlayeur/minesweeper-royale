...
export default function Layout({ children }) {
    ...
    return (
        <div className="flex flex-col justify-between h-screen w-screen bg-slate-500 items-center overflow-hiden">
            ...
            <div className="mx-auto flex items-center justify-center w-screen h-[90svh]">
                {children}
            </div>
